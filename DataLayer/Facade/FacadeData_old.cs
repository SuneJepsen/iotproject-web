...
//        {
//            rawDataFloorRepo = new FirebaseDbAlt<MeasurementRaw>(string.Format(FirebaseConnectionString.RawData, FirebaseConnectionString.RawDataFloorNodeId, string.Empty), FirebaseConnectionString.RawDataFloorNodeId);
...
//            copyDataFloorRepo = new FirebaseDb<Measurement>(string.Format(FirebaseConnectionString.CopyData, DateTime.Now.ToString("dd-MM-yyyy")));
